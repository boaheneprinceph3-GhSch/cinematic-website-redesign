 ...
 * Converted from React component for Balstudio
 * Creates animated wavy lines with cursor interaction using Perlin noise
 */
...
class WavesBackground {
    constructor(container, options = {}) {
        ...
        // Configuration
        this.config = {
            lineColor: options.lineColor || 'rgba(139, 115, 85, 0.15)', // Balstudio warm accent
...
// Auto-initialize on sections with .waves-bg class
document.addEventListener('DOMContentLoaded', function() {
    const sections = document.querySelectorAll('.waves-bg');
    sections.forEach(section => {
        new WavesBackground(section, {
            lineColor: 'rgba(139, 115, 85, 0.12)', // Balstudio warm accent with low opacity
            waveSpeedX: 0.015,
            waveSpeedY: 0.008,
            waveAmpX: 28,
            waveAmpY: 14,
